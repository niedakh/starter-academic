...
publication: "WER we are and WER we think we are"
publication_short: "WER we are and WER we think we are"
...
links:
- name: Custom Link
  url: https://arxiv.org/abs/2010.03432
url_pdf: http://arxiv.org/pdf/2010.03432
url_code: '#'
url_dataset: '#'
url_poster: '#'
url_project: ''
...
image:
  caption: 'WER ranges in ASR systems. Reference values taken from the Wer are we report \cite{synnaeve_2020} and the \textit{Papers with Code} website \cite{papers_with_code} for ASR solutions published in the last 5 years. Outliers were removed for the sake of figure readability.'
  focal_point: ""
  preview_only: false
